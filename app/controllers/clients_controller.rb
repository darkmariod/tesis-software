...
class ClientsController < ApplicationController
  ...
  private
    ...
    def client_params
      params.require(:client).permit(:nombre_cliente, :codigo_cliente, :ruc, :direccion, :telefono, :email, :fecha_falla_del_equipo, :tecnico_a_cargo, :hora_de_inicio, :hora_final, :trabajo_realizado, :observaciones_del_tecnico, :firma_del_cliente)
    end
end
